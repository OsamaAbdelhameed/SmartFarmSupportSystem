<%-- 
    Document   : viewCrops
    Created on : Jan 1, 2022, 7:53:49 AM
    Author     : OSAMA
--%>
...
<html>
    ...
    <body>
        ...
        <%          int index = 1;
                    ...
                    String sql = "SELECT * FROM Crop where enabled='on'";
                        ...
                        <div class="card-body">
                            <form action="RequestCtrl" method="post">
                                <div class="form-group">
                                    <p>Crop Name: <%=rs.getString("name") %></p> 
                                    <br>
                                    <div class="form-group form-inline"> 
                                        <p>Start planted in <%=rs.getString("startMonth") %> and ends in <%=rs.getString("endMonth") %> or during <%=rs.getString("season") %> season. </p>
                                    </div>
                                    <br>
                                    <div class="form-group form-inline"> 
                                        <p>We provide a financial support for seeds, 1 Kg of seeds costs <%=rs.getString("price") %>RM and you can request more than 5Kg until 10Kg. </p>
                                    </div>
                                    <br>
                                </div><br>
                                <img src="images/<%=rs.getString("image") %>" alt="<%=rs.getString("image") %> image is not available" width="300" height="300">
                                <br>
                                <div class="form-group">
                                ...
                                Quantity needed: <input type="number" name="quantity" min="0" max="10" placeholder="Please enter number of needed Kgs" required><br>
