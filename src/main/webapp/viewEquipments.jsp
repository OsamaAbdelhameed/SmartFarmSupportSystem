<%-- 
    Document   : viewEquipments
    Created on : Jan 1, 2022, 12:00:08 PM
    Author     : OSAMA
--%>
...
<html>
    ...
    <body>
        ...
        <%          int index = 1;
                    ...
                    String sql = "SELECT * FROM Equipment where enabled='on'";
                ...
                <div align="center" style='width:80%'>
                    <div class="card">
                        <div class="card-header text-center">
                            <br>
                            <h3>Equipment <%=index++ %></h3>
                        </div>
                        <div class="card-body">
                            <form action="RequestCtrl" method="post">
                                <div class="form-group">
                                    <p>Equipment Name: <%=rs.getString("name") %></p> 
                                    <br>
                                    <div class="form-group form-inline"> 
                                        <p><%=rs.getString("name") %> range is <%=rs.getString("equipRange") %>m<sup>2</sup> </p>
                                    </div>
                                    <br>
                                    <div class="form-group form-inline"> 
                                        <p>We provide a financial support for equipment, for each one it costs <%=rs.getDouble("price") %>RM and you can request no more than 2. </p>
                                    </div>
                                    <br>
                                </div><br>
                                <img src="images/<%=rs.getString("image") %>" alt="<%=rs.getString("image") %> image is not available" width="500" height="300">
                                <br>
                                <div class="form-group">
                                ...
                                Quantity needed: <input type="number" name="quantity" min="0" max="2" placeholder="Please enter number of needed Kgs" required><br>
