<%-- 
    Document   : deleteView
    Created on : Dec 31, 2021, 7:41:09 PM
    Author     : OSAMA
--%>
...
<html>
    ...
    <body>
        <h1 align="center" style="margin: 50px;">Delete Supplies</h1>
        <div  align="center" class="container"  style="margin-top: 50px; margin-bottom: 100px; margin-left: 500px; text-align: center; width:30%;">
            <div class="row">
                <div class="col-md-8 offset-md-1">
                    <div class="card">
                        <form method="post" action="deleteView.jsp">
        ...
        %>
        <h1 align="center" style="margin: 50px;">Choose Crop to Delete</h1>
        <div  align="center" class="container"  style="margin-top: 50px; margin-bottom: 100px; margin-left: 500px; text-align: center; width:30%;">
            <div class="row">
                <div class="col-md-8 offset-md-1">
                    <div class="card">
                        <form method="post" action="CropCtrl">
                            <div class="form-group form-inline"> 
                            ...
                            <button type="submit" class="btn btn-primary" name="Action" value="Delete">Choose</button>
                        </form>
                    </div>
                </div>
            </div> 
        ...
        %>
        <h1 align="center" style="margin: 50px;">Choose Equipment to Delete</h1>
        <div  align="center" class="container"  style="margin-top: 50px; margin-bottom: 100px; margin-left: 500px; text-align: center; width:30%;">
            <div class="row">
                <div class="col-md-8 offset-md-1">
                    <div class="card">
                        <form method="post" action="EquipmentCtrl">
                            <div class="form-group form-inline"> 
        ...
        %>
        <h1 align="center" style="margin: 50px;">Choose Insecticide to Delete</h1>
        <div  align="center" class="container"  style="margin-top: 50px; margin-bottom: 100px; margin-left: 500px; text-align: center; width:30%;">
            <div class="row">
                <div class="col-md-8 offset-md-1">
                    <div class="card">
                        <form method="post" action="InsecticideCtrl">
                            <div class="form-group form-inline"> 
        ...
        %>
        <h1 align="center" style="margin: 50px;">Choose Fertilizer to Delete</h1>
        <div  align="center" class="container"  style="margin-top: 50px; margin-bottom: 100px; margin-left: 500px; text-align: center; width:30%;">
            <div class="row">
                <div class="col-md-8 offset-md-1">
                    <div class="card">
                        <form method="post" action="FertilizerCtrl">
                            <div class="form-group form-inline"> 
