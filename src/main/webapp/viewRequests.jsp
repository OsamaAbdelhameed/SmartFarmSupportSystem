<%-- 
    ...
    Created on : Jan 6, 2022, 1:36:27 AM
    Author     : OSAMA
--%>
    ...
    <body>
        ...
        <table class="table" border="1">
            ...
            <%    int index = 1;
                ...
                String str = "SELECT * FROM Request WHERE name='"+session.getAttribute("user")+"'";
            ...
            <tr>
                ...
                <td width="250px"><% if(rs.getString("status").equals("Accepted")) { %> <form method="post" action="RequestCtrl"><%--<input type="hidden" name="type" value="<%=rs.getString("type")%>">--%><input type="hidden" name="time" value="<%=rs.getString("time")%>"><button type="submit" class="btn btn-primary" style="background-color: green;" name="Action" value="Received">Received</button>&nbsp;&nbsp; <button type="submit" class="btn btn-primary" style="background-color: red;"  name="Action" value="Corrupt">Corrupted</button></form> 
                    <%}else{
