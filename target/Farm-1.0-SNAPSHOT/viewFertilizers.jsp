<%-- 
    Document   : viewFertilizers
    Created on : Jan 1, 2022, 1:40:39 PM
    Author     : OSAMA
--%>
...
<html>
    ...
    <body>
        <h1 align="center">Fertilizers</h1>
        ...
        <%          int index = 1;
                    ...
                    String sql = "SELECT * FROM Fertilizer where enabled='on'";
                        ...
                        <div class="card-body">
                            <form action="RequestCtrl" method="post">
                                <div class="form-group">
                                    <p>Fertilizer Name: <%=rs.getString("name") %></p> 
                                    <br>
                                    <div class="form-group form-inline"> 
                                        <p><%=rs.getString("name") %> can help <%=rs.getString("plantType") %> to grow faster </p>
                                    </div>
                                    <br>
                                    <div class="form-group form-inline"> 
                                        <p><%=rs.getString("name") %> range is <%=rs.getString("fertRange") %>m<sup>2</sup> </p>
                                    </div>
                                    <br>
                                    <div class="form-group form-inline"> 
                                        <p>We provide a financial support for fertilizer, for each one it costs <%=rs.getDouble("price") %>RM and you can request no lower than 5. </p>
                                    </div>
                                    <br>
                                </div><br>
