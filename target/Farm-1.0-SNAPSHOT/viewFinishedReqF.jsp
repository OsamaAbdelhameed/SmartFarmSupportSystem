<%-- 
    Document   : viewFinishedReqF
    Created on : Jan 5, 2022, 9:26:13 PM
    Author     : OSAMA
--%>
    ...
    <body>
        ...
        <table class="table" border="1">
            ...
            <%    int index = 1;
                ...
                String str = "SELECT * FROM Request WHERE name='"+ session.getAttribute("user") +"' AND status in ('Rejected', 'Delivered', 'Corrupted')";
