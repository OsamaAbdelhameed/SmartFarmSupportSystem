<%-- 
    Document   : supplierheader
    Created on : Jan 6, 2022, 8:14:42 PM
    Author     : OSAMA
--%>
...
<html>
    ...
    <%
        if (request.getSession(false).getAttribute("supplier") == null) {
    %>
    ...
    <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #8bc34a;">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <%--<li class="nav-item active">
                    <a class="nav-link" href="sendView.jsp">Provide Supplies</a>
                </li>--%>
                <li class="nav-item active">
                    <a class="nav-link" href="consumedView.jsp">Consumption</a>
                </li>
                ...
                <li class="nav-item dropdown active" >
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        <a class="dropdown-item" href="ChangeUser.jsp">Change Supplier Information</a>
